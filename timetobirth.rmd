...
La répartition des événements montrent que les censures sont plutot situé aprèe 150 jours. Les événements de fin de grosesse sont eux plutot situé aux alentour de 75 jours.
...
legend(120, -1.17, levels(d2g$bmiFQual), lty = 2:3,col=colList) 
...
legend(120, -1.17, levels(d2g$bmiHQual), lty = 2:3,col=colList)
...
legend(120, -1.17, levels(d2g$ageFQual), lty = 2:3,col=colList)
...
legend(120, -1.17, levels(d2g$ageHQual), lty = 2:3,colList)
```
...
legend(120, -1.17, c("Non fumeuse","Fumeuse"), lty = 2:3,col=colList)
summary(fit)$table
```
...
legend(120, -1.17, c("Non fumeur","Fumeur"), lty = 2:3,col=colList)
...
legend(120, -1.17, levels(d2g$spermQual), lty = 2:3,col=colList)
```
...
legend(130, -1, levels(d2g$fumAlcF), lty = 2:10,col=colList)
```
...
On commencera par étudier la forme de la fonction de survie globale en essayant de la modéliser par une loi de weibull. Puis nous ajouterons les covariables afin d'ideintifier un modèle utilisable.
...
#coxph(Surv(d2g,indic)  ~ bmiF + bmiH+alcF+alcH+fumF+fumH+ageH+sperm , d2g)
#coxph(Surv(d2g,indic)  ~ bmiF + bmiH+alcF+alcH+fumF+ageH+sperm , d2g)
#coxph(Surv(d2g,indic)  ~ bmiF + bmiH+alcH+fumF+ageH+sperm , d2g)
#coxph(Surv(d2g,indic)  ~ bmiF + bmiH+alcH+fumF+ageH , d2g)
#coxph(Surv(d2g,indic)  ~ bmiF + bmiH+alcH+fumF , d2g)
#coxph(Surv(d2g,indic)  ~ bmiH+alcH+fumF , d2g)
#coxph(Surv(d2g,indic)  ~ bmiH+fumF , d2g)
cox<-coxph(Surv(d2g,indic)  ~ fumF , d2g)
```

#coxph(Surv(d2g,indic)  ~ fumAlcF, d2g)

```{r}
summary(survreg(Surv(d2g,indic)  ~ bmiF + bmiH+alcF+alcH+fumF+fumH+ageF+ageH+sperm , d2g, dist='weibull'))
summary(survreg(Surv(d2g,indic)  ~ bmiF + bmiH+alcF+alcH+fumF+fumH+ageH+sperm , d2g, dist='weibull'))
summary(survreg(Surv(d2g,indic)  ~ bmiF + bmiH+alcF+alcH+fumF+ageH+sperm , d2g, dist='weibull'))
summary(survreg(Surv(d2g,indic)  ~ bmiF + bmiH+alcH+fumF+ageH+sperm , d2g, dist='weibull'))
summary(survreg(Surv(d2g,indic)  ~ bmiF + bmiH+fumF+ageH+sperm , d2g, dist='weibull'))
summary(survreg(Surv(d2g,indic)  ~ bmiH+fumF+ageH+sperm , d2g, dist='weibull'))
summary(survreg(Surv(d2g,indic)  ~ bmiH+fumF+ageH , d2g, dist='weibull'))
summary(survreg(Surv(d2g,indic)  ~ bmiH+fumF , d2g, dist='weibull'))

summary(survreg(Surv(d2g,indic)  ~ fumAlcF , d2g, dist='weibull'))

d2g$fumAlcF=as.factor(paste(d2g$fumF,d2g$alcFQual,' '))
d2g$fumFBmiH=as.factor(paste(d2g$fumF,d2g$bmiHQual,' '))
d2g$fumFBmiF=as.factor(paste(d2g$fumF,d2g$bmiFQual,' '))
d2g$fumAgeF=as.factor(paste(d2g$fumF,d2g$ageFQual,' '))

d2g$fumAlcBmiF=as.factor(paste(d2g$fumAlcF,d2g$bmiFQual,' '))
d2g$fumAlcBmiAgeF=paste(d2g$fumAlcBmiF,d2g$ageFQual,' ')

summary(survreg(Surv(d2g,indic)  ~ bmiH+fumF+fumAlcF , d2g, dist='weibull'))

summary(survreg(Surv(d2g,indic)  ~ bmiH+fumF+fumAlcF , d2g, dist='weibull'))

fit <- survfit(Surv(d2g, indic) ~ fumAlcF, data = d2g) 
plot(fit, lty = 2:8,col=colList) 
title("Fonction de survie - Sperm")
legend(130, .97, levels(d2g$fumAlcF), lty = 2:8,col=colList)

fit <- survfit(Surv(d2g, indic) ~ fumFBmiH, data = d2g) 
plot(fit, lty = 2:30,col=colList) 
title("Fonction de survie - Sperm")
legend(130, .97, levels(d2g$fumFBmiH), lty = 2:30,col=colList)

fit <- survfit(Surv(d2g, indic) ~ fumFBmiF, data = d2g) 
plot(fit, lty = 2:30,col=colList) 
title("Fonction de survie - Sperm")
legend(130, .97, levels(d2g$fumFBmiF), lty = 2:30,col=colList)

fit <- survfit(Surv(d2g, indic) ~ fumAgeF, data = d2g) 
plot(fit, lty = 2:30,col=colList) 
title("Fonction de survie - Sperm")
legend(130, .97, levels(d2g$fumAgeF), lty = 2:30,col=colList)
