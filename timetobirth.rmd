...
summary(fit)$table
```
Les fumeuses ont un survie plus importante que les non fumeuses. L'écart s'agrandi en fonction du délai. Les risque sont presque paralleles avec quelques entrecroisements. 
...
```
Comme pour les femmes les hommes fumeurs ont une courbe de survie légèremment plus importante. La courbe de risque paressant parrallele, on utilise le test du log rank qui nous permet de conclure à l'égalité des courbes de survie. 
